...
export default function StandaloneAboutUsPage() {
  return (
    <main className="w-full min-h-screen relative py-28 px-6 md:px-12 flex flex-col items-center justify-center overflow-hidden bg-[#030712] antialiased select-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl w-full mx-auto relative z-30">
        {/* CARD 01 */}
        <div className="bg-zinc-900/40 backdrop-blur-2xl border border-white/10 p-8 rounded-2xl flex flex-col justify-between text-left shadow-[0_20px_50px_rgba(0,0,0,0.6)] min-h-[280px]">
          <div>
