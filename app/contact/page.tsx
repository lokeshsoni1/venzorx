...
export default function StandaloneContactPage() {
  ...
  return (
    <main className="w-full min-h-screen relative py-28 px-6 md:px-12 flex flex-col items-center justify-center bg-[#030712] overflow-hidden antialiased select-none">
      ...
      <div className="w-full max-w-xl mx-auto p-8 rounded-3xl border border-white/10 bg-zinc-900/40 backdrop-blur-2xl shadow-[0_30px_60px_rgba(0,0,0,0.7)] mb-12 relative z-10">
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <input
            ...
            className="bg-zinc-950/60 border border-white/5 rounded-xl px-4 py-3.5 text-white placeholder-zinc-600 focus:border-cyan-400/70 outline-none text-sm w-full mb-4 transition-colors"
            required
          />
          ...
          <textarea
            ...
            className="bg-zinc-950/60 border border-white/5 rounded-xl px-4 py-3.5 text-white placeholder-zinc-600 focus:border-cyan-400/70 outline-none text-sm w-full mb-6 resize-none transition-colors"
            required
          />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
            ...
            <motion.a
              ...
              className="flex items-center justify-center gap-2 bg-cyan-500 hover:bg-cyan-400 text-white font-mono text-xs tracking-wider font-bold uppercase rounded-xl py-4 transition-all duration-300 shadow-[0_10px_25px_rgba(6,182,212,0.15)] text-center cursor-pointer transform-gpu backface-hidden"
            >
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 border border-white/10 bg-zinc-950/40 hover:bg-zinc-950/80 text-white font-mono text-xs tracking-wider font-bold uppercase rounded-xl py-4 transition-all duration-300 text-center cursor-pointer transform-gpu backface-hidden"
            >
