        ...
        <div className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center p-6">
                ...
                <motion.h1
                    ...
                    initial="hidden"
                    animate="visible"
                    className="text-5xl md:text-8xl font-bold tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-r from-cyan-200 via-sky-300 to-blue-500"
                >
                    VenzorX
                </motion.h1>
                ...
                <motion.div
                    ...
                    animate="visible"
                >
                    <button className="px-8 py-4 bg-cyan-500 text-white hover:bg-cyan-400 font-semibold rounded-lg shadow-lg hover:bg-gray-200 transition-colors duration-300 flex items-center gap-2 mx-auto">
                        Book a Demo
